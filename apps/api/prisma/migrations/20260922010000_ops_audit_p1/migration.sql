...
-- AlterTable
-- AlterTable
-- หมวดเอกสารถูกเพิ่มเป็น enum "DocumentCategory" ใน 20260922040000 แทน free text
-- (ต้องกรอง/จัดกลุ่ม/ทำรายงานได้ และเทียบกับ CaseType.requiredDocuments ได้ตรง ๆ)
